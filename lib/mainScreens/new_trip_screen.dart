...
class _NewTripScreenState extends State<NewTripScreen>
{
  ...
  updateDurationTimeAtRealTime() async
  {
    if(isRequestDirectionDetails == false)
    {
      ...
      {
        destinationLatLng = widget.userRideRequestDetails!.destinationLaLng;//user DropOff location
      }
                ...
                child: Column(
                  children: [
                    ...
                    ElevatedButton.icon(
                      onPressed: () async
                      {
                        if(statusBtn == "accepted")//driver has arrived at user pick up location
                          {
                            statusBtn = "arrived";
                            ...
                            await drawPolyLineFromOriginToDestination(
                                ...
                                widget.userRideRequestDetails!.destinationLaLng!
                            );
